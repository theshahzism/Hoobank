    ...
    <section id="product" className={`${layout.sectionReverse}`}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          ...
          culpa deleniti adipisci error libero porro nobis accusantium a
          consectetur possimus? A debitis praesentium in pariatur tempore
          necessitatibus ea quibusdam asperiores.{" "}
        </p>
